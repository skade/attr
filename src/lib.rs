...
pub trait IndexableAttr<'a, 'b: 'a, Type: 'b + ?Sized, Idx: ?Sized> : Attr<'a, 'b, Type> {
    ...
    fn at(&self, i: Type, idx: Idx) -> &'a <Self as IndexableAttr<'a, 'b, Type, Idx>>::Output;
}
...
impl<'a, 'b: 'a, X: 'b, Y: 'b, Z: 'a, A: Attr<'a, 'b, X, Output=Y>, R: Traverse<'a, 'b, Y, Z> + 'b> Traverse<'a, 'b, X, Z> for ImmutablePath<'a, 'b, X, Y, Z, A, R> {
...
impl<'a, 'b: 'a, X: 'b, Y: 'b, Z: 'a, A: IterableAttr<'a, 'b, X, Item=Y>, R: Traverse<'a, 'b, Y, Z>> Traverse<'a, 'b, X, Box<Iterator<Item=Z> + 'a>> for ImmutableMapPath<'a, 'b, X, Y, Z, A, R> {
...
pub struct ImmutablePath<'a, 'b: 'a, X: 'b + ?Sized, Y: 'b + ?Sized, Z: 'a + ?Sized, A: Attr<'a, 'b, X, Output=Y>, R: Traverse<'a, 'b, Y, Z>> {
    attr: A,
    next: R,
...
pub struct ImmutableMapPath<'a, 'b: 'a, X: 'b + ?Sized, Y: 'b + ?Sized, Z: 'a + ?Sized, A: IterableAttr<'a, 'b, X, Item=Y>, R: Traverse<'a, 'b, Y, Z>> {
    attr: A,
    next: R,
    phantomx: PhantomData<&'b X>,
    phantomy: PhantomData<&'b Y>,
...
pub fn retrieve<'a, T, A: Attr<'a, 'a, T>>(attr: A) -> ImmutablePath<'a, 'a, T, A::Output, A::Output, A, Identity>
...
impl<'a, 'b: 'a, X: 'b, Y: 'a, Z: 'a, A: Attr<'a, 'b, X, Output=Y>, R: Traverse<'a, 'b, Y, Z>> ImmutablePath<'a, 'b, X, Y, Z, A, R> {
...
impl<'a, 'b: 'a, X: 'b, Y: 'a, Z: 'a, A: IterableAttr<'a, 'b, X, Item=Y>, R: Traverse<'a, 'b, Y, Z>> ImmutableMapPath<'a, 'b, X, Y, Z, A, R> {
    pub fn from<NX, NY, NA>(self, attr: NA) -> ImmutablePath<'a, 'b, NX, NY, Box<std::iter::Iterator<Item=Z> + 'a>, NA, Self>
        where NA: Attr<'a, 'b, NX, Output=NY>,
